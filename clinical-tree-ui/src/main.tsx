...
if (path === '/orthopedics/reasoning') {
  ...
  document.getElementById('root')!.innerHTML = `
    <div style="display:flex;align-items:center;justify-content:center;height:100vh;background:#f8f9fb;font-family:system-ui,sans-serif;">
      <div style="text-align:center;color:#555;max-width:560px;">
        <img src="${fullLogoUrl}" alt="Clinical Reasoning Tree" style="display:block;margin:0 auto 24px;max-width:455px;" />
        <div style="font-size:18px;font-weight:500;color:#111;margin-bottom:8px;">Demo is at <a href="/orthopedics" style="color:#1A52A8;text-decoration:none;">/orthopedics</a></div>
